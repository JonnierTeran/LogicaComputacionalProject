 ...
 * @author Usuario
 */
public class Condicional_IdentificaodorMes extends javax.swing.JFrame {

    /**
     * Creates new form Condicional_IdentificaodorMes
     */
    public Condicional_IdentificaodorMes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel18.setText("IDENTIFICADOR DIA DE MES");

        jLabel19.setText("Numero de Mes");
        ...
        BtnCalcu.setText("Verificar Mes");
        ...
        jLabel20.setText("Condicionales y switch");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Condicional_IdentificaodorMes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Condicional_IdentificaodorMes().setVisible(true);
            }
        });
    }
